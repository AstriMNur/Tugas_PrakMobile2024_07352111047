          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 150,
                    color: const Color.fromARGB(255, 230, 228, 200),
                    child: Center(
                      child: Text(
                        'Today’s Deal\n50% OFF',
                        style: TextStyle(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      color: const Color.fromARGB(255, 245, 190, 70),
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ProfileCard(
                              imageUrl:
                                  'https://cdn.pixabay.com/photo/2017/07/28/14/28/macarons-2548818_1280.jpg',
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ServiceCard(
                  imageUrl:
                      'https://cdn.pixabay.com/photo/2016/12/06/15/26/cookies-1886760_1280.jpg',
                    ...
                    children: [
                      Container(
                        ...
                        color: const Color.fromARGB(
                            255, 245, 190, 70), // Warna latar belakang biru
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: NetworkImage(
                                'https://cdn.pixabay.com/photo/2020/12/06/15/52/cookies-5809181_1280.jpg'), // URL gambar
                            fit: BoxFit.cover,
                          ),
                          borderRadius: BorderRadius.circular(10),
                        ),
                                ...
                                children: [
                                  CircleAvatar(
                                    ...
                                    backgroundImage: NetworkImage(
                                        "https://www.istockphoto.com/photo/macaroon-gm1732923393-541928936?utm_source=pixabay&utm_medium=affiliate&utm_campaign=ADP_photo_sponsored&utm_content=https%3A%2F%2Fpixabay.com%2Fid%2Fphotos%2Fmakaroni-raspberi-kue-kering-2548818%2F&utm_term=macarons+himbeeren"),
                                  ),
                                  SizedBox(
                                    width: 20,
                                  ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              const Color.fromARGB(255, 245, 190, 70),
                              const Color.fromARGB(255, 255, 221, 147),
                              const Color.fromARGB(255, 248, 247, 246)
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                return WorkshopCard(
                  imageUrl:
                      'https://cdn.pixabay.com/photo/2017/11/24/20/01/christmas-cookies-2975570_1280.jpg',
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: NetworkImage(
                    'https://cdn.pixabay.com/photo/2015/11/19/20/17/cookies-1051884_1280.jpg'), // URL gambar kamu
                fit:
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              instructor,
              style: TextStyle(
                  fontSize: 14, color: const Color.fromARGB(255, 245, 190, 70)),
            ),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8.0),
            child: Text(
              "ini ngana pe pilihan Kue?",
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: const Color.fromARGB(
                    255, 245, 190, 70), // Warna teks tombol
              ),
            ),
          ),
        ],
